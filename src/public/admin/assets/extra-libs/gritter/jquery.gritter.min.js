(function (b) {
    ...
    var a = {
        ...
        stop: function (e) {
            var c = b.isFunction(e.before_close)
                ? e.before_close
                : function () {};
            var f = b.isFunction(e.after_close)
                ? e.after_close
                : function () {};
        ...
        _str_replace: function (v, e, o, n) {
            ...
            for (k = 0, g = u.length; k < g; k++) {
                ...
                for (h = 0, q = l.length; h < q; h++) {
                    ...
                    if (n && u[k] !== t) {
                        this.window[n] +=
                            (t.length - u[k].length) / l[h].length;
                    }
                }
            }
            return p ? u : u[0];
