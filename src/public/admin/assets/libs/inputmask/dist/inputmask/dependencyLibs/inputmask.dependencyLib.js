...
!(function (factory) {
    ...
    for (
        ...
        class2type['[object ' + classTypes[nameNdx] + ']'] = classTypes[
            nameNdx
        ].toLowerCase();
    return (
                        ...
                        if (void 0 !== document && 'global' === namespace) {
                            var evnt,
                                ...
                                params = {
                                    bubbles: !0,
                                    cancelable: !0,
                                    detail: Array.prototype.slice.call(
                                        arguments,
                                        1,
                                    ),
                                };
                            ...
                            if (
                                ...
                                for (var nmsp in eventRegistry[ev])
                                    for (
                                        i = 0;
                                        i < eventRegistry[ev][nmsp].length;
                                        i++
                                    )
                                        eventRegistry[ev][nmsp][i].apply(
                                            elem,
                                            arguments,
                                        );
                            else
                                for (
                                    i = 0;
                                    i < eventRegistry[ev][namespace].length;
                                    i++
                                )
                                    eventRegistry[ev][namespace][i].apply(
                                        elem,
                                        arguments,
                                    );
                    }
                                ...
                                (DependencyLib.isPlainObject(copy) ||
                                    ...
                                    ? (copyIsArray
                                          ? ((copyIsArray = !1),
                                            (clone =
                                                src &&
                                                DependencyLib.isArray(src)
                                                    ? src
                                                    : []))
                                          : (clone =
                                                src &&
                                                DependencyLib.isPlainObject(src)
                                                    ? src
                                                    : {}),
