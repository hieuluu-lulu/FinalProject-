        ...
        function getMaskTemplate(baseOnInput, minimalPos, includeMode) {
            ...
            do {
                !0 === baseOnInput && getMaskSet().validPositions[pos]
                    ? ((test = (testPos = getMaskSet().validPositions[pos])
                          .match),
                        ...
                        ((!getMaskSet().validPositions[i].match.optionality &&
                            (function (pos) {
                                ...
                                if (
                                    ...
                                    var prevMatch = getMaskSet().validPositions[
                                            pos - 1
                                        ],
                                        nextMatch = getMaskSet().validPositions[
                                            pos + 1
                                        ];
                                    return (
                                        prevMatch !== undefined &&
                ...
                function handleMatch(match, loopNdx, quantifierRecurse) {
                    ...
                    function resolveNdxInitializer(
                        ...
                        if (
                            ...
                            for (
                                var vpAlternation = getMaskSet().validPositions[
                                        pos - 1
                                    ].locator,
                                    tpAlternation = getMaskSet().tests[pos][0]
                                        .locator,
                                    i = 0;
                                i < targetAlternation;
                                i++
                    ...
                    $.each(getTests(position), function (ndx, tst) {
                        ...
                        if (
                            ...
                            elem =
                                ...
                                null === test.fn
                                    ? getPlaceholder(position, test, !0) ||
                                      test.def
                                    : elem;
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    return (
                                        (rslt.pos = getLastValidPosition()), !1
                                    );
                                if (
                                    (validatedPos =
                                        rslt.pos !== undefined
                    ...
                    if (
                        ...
                        if (
                            ...
                            for (
                                ...
                                if (
                                    !1 !== (result = _isValid(nPos, c, strict))
                                ) {
                                    !(function (originalPos, newPos) {
                                        var vp = getMaskSet().validPositions[
                                            newPos
                                        ];
                                        if (vp)
                                            for (
                ...
                !1 === result &&
                    ...
                    (result = (function (pos, c, strict) {
                        ...
                        if (alternation !== undefined) {
                            ...
                            var possibilityPos = getMaskSet().validPositions[
                                    decisionPos
                                ],
                    ...
                    (function () {
                        if (opts.keepStatic) {
                            for (
                                ...
                                var altPos = getMaskSet().validPositions[
                                    lastAlt
                                ];
                                if (altPos) {
                                    if (
                                        ...
                                        delete getMaskSet().validPositions[
                                            lastAlt
                                        ],
                                        altPos.alternation !== undefined &&
                                            altPos.locator[
                        ...
                        event
                            ...
                            $.each(events, function (eventName, evArr) {
                                for (; evArr.length > 0; ) {
                                    var ev = evArr.pop();
                                    -1 !==
                                    $.inArray(eventName, ['submit', 'reset'])
                                        ? null !== input.form &&
            ...
            EventHandlers = {
                        ...
                        if (frontPart !== frontBufferPart) {
                            ...
                            for (
                                var fpl = (isEntry =
                                    ...
                                    i = 0;
                                frontPart.charAt(i) ===
                                    frontBufferPart.charAt(i) && i < fpl;
                                i++
                            )
                                selection.begin++;
                            isEntry &&
                ...
                setValueEvent: function (e) {
                    ...
                    $.isFunction(opts.onBeforeMask) &&
                        (value =
                            opts.onBeforeMask.call(inputmask, value, opts) ||
                            value),
                        (value = value.split('')),
                        checkVal(
                            input,
