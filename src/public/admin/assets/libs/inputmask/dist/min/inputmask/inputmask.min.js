...
!(function (e) {
    ...
    function s(r, o, l) {
        function h(e, t, n) {
            ...
            do {
                !0 === e && m().validPositions[c]
                    ? ((r = (o = m().validPositions[c]).match),
                      (a = o.locator.slice()),
                      s.push(
                          !0 === n ? o.input : !1 === n ? r.nativeDef : G(c, r),
                      ))
                    : ((r = (o = y(c, a, c - 1)).match),
                      (a = o.locator.slice()),
                      (!1 === l.jitMasking ||
            ...
            return (
                '' === s[s.length - 1] && s.pop(), (m().maskLength = c + 1), s
            );
        }
        function m() {
            return o;
        ...
        function g(t, n, a, r) {
            ...
            for (d(!0), o = s + 1; o <= v(); ) {
                ...
                if ((o < s && (o = s + 1), m().validPositions[o] === i && O(o)))
                    o++;
                else {
                    var f = y(o);
                ...
                (!(
                    ...
                    (o.alternation === i ||
                        ...
                        (n.locator[o.alternation] !== i &&
                            w(
                                n.locator[o.alternation].toString().split(','),
                                s,
                            )))
                ) ||
                    (!0 === t &&
        ...
        function E(t, n, a) {
            function r(n, a, o, c) {
                function f(o, c, v) {
                    ...
                    if (u === t && o.matches === i)
                        return (
                            p.push({ match: o, locator: c.reverse(), cd: d }),
                            !0
                        );
                    if (o.matches !== i) {
                        if (o.isGroup && v !== o) {
                            if (
                                (o = f(
                                    n.matches[e.inArray(o, n.matches) + 1],
                                    c,
                                ))
                            )
                                return !0;
                            ...
                            for (
                                ...
                                F <
                                    (isNaN(I.quantifier.max)
                                        ? F + 1
                                        : I.quantifier.max) && u <= t;
                                F++
                            ) {
            ...
            function o(e) {
                if (
                    ...
                    if (
                        m().validPositions[t - 1].alternation ===
                        e[0].alternation
                    )
                        return [k(e)];
            ...
            if (t > -1) {
                if (n === i) {
                    for (
                        var v, g = t - 1;
                        (v = m().validPositions[g] || m().tests[g]) === i &&
                        g > -1;
        ...
        function _(e, t, n) {
            ...
            for (r = e, a = e; a < t; a++)
                if ((d(!0), n[a] !== l.skipOptionalPartCharacter)) {
                    var o = M(r, n[a], !0, !0);
                    !1 !== o &&
                        (d(!0), (r = o.caret !== i ? o.caret : o.pos + 1));
                }
        }
        function x(t, n, i) {
        ...
        function M(t, n, r, o, s, c) {
            function u(e) {
                ...
                return t && 0 === e.begin && e.end === m().maskLength
                    ? 'full'
                    : t;
            }
            function f(n, a, r) {
            ...
            function p(t, n, a, r) {
                if (
                    r ||
                    (l.insertMode && m().validPositions[t] !== i && a === i)
                ) {
                    var o,
                        ...
                        if (y !== i)
                            for (
                                ...
                                if (
                                    ...
                                    !1 === g &&
                                        s[b] &&
                                        s[b].match.def === y.match.def)
                                )
                                    (m().validPositions[b] = e.extend(
                                        !0,
                                        {},
                                        s[b],
                                    )),
            ...
            if (
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            (l.insertMode || m().validPositions[S(b)] === i) &&
                            !O(b, !0)
                        )
                ...
                !1 === C &&
                    ...
                    (C = (function (t, n, a) {
                        ...
                        for (u = m().validPositions[b]; b >= 0; b--)
                            if (
                                (c = m().validPositions[b]) &&
                                c.alternation !== i
                            ) {
                                if (
                                    ((r = b),
                                    (s = m().validPositions[r].alternation),
                                    u.locator[c.alternation] !==
                        ...
                        if (s !== i) {
                            ...
                            e.each(
                                E(g, A ? A.locator : i, g - 1),
                                function (r, c) {
                                    h = c.locator[s]
                                        ? c.locator[s].toString().split(',')
                                        : [];
                                    for (var u = 0; u < h.length; u++) {
                                        ...
                                        if (
                                            ...
                                            (c.na === i ||
                                                ...
                                                -1 ===
                                                    e.inArray(P.toString(), h))
                                        ) {
                                            m().validPositions[g] = e.extend(
                                                !0,
                                                {},
                                                c,
                                            );
                                            var x = m().validPositions[g]
                                                .locator;
                                            for (
                                                m().validPositions[g].locator[
                                                    s
                                                ] = parseInt(h[u]),
                                                    null == c.match.fn
                                                        ? (C.input !==
                    ...
                    if (
                        ...
                        for (var c = 0; c < o.length; c++)
                            if (
                                ...
                                return l.placeholder.charAt(
                                    t % l.placeholder.length,
                                );
                }
                return n.def;
            }
        ...
        function L(t, r, o, s, c) {
            ...
            if ((d(), o || !0 === l.autoUnmask)) h = S(h);
                ...
                var k = C().slice(0, S(-1)).join(''),
                    P = f
                        .join('')
                        .match(new RegExp('^' + a.escapeRegex(k), 'g'));
                P &&
                    P.length > 0 &&
                    (f.splice(0, P.length * k.length), (h = S(h)));
            }
            if (
        ...
        function K(t, n, r, o, s) {
            ...
            n === a.keyCode.BACKSPACE &&
            (r.end - r.begin < 1 || !1 === l.insertMode)
                ? ((r.begin = D(r.begin)),
        ...
        function U(i) {
            ...
            var r = (i.ownerDocument.defaultView || t).getComputedStyle(
                    i,
                    null,
                ),
            ...
            ne = {
                keydownEvent: function (t) {
                    ...
                    if (
                        ...
                        (o === a.keyCode.HOME && !t.shiftKey) ||
                        o === a.keyCode.PAGE_UP
                            ? (t.preventDefault(),
                              I(i, 0, t.shiftKey ? s.begin : 0, !0))
                    ...
                    if (f) {
                        ...
                        if (
                            ...
                            T(
                                c,
                                k,
                                l.numericInput && g.caret === i ? D(p) : p,
                                t,
                                !0 !== n,
                            ),
                                !0 !== n &&
                ...
                pasteEvent: function (n) {
                    ...
                    if (
                        (u ===
                            (z ? C().reverse() : C())
                                .slice(0, c.begin)
                                .join('') && (u = ''),
                        f === (z ? C().reverse() : C()).slice(c.end).join('') &&
                            (f = ''),
                        z && ((i = u), (u = f), (f = i)),
                    ...
                    return (
                        L(
                            ...
                            !1,
                            !1,
                            z ? p.split('').reverse() : p.toString().split(''),
                        ),
                    ...
                    if (a.inputmask) {
                        ...
                        '' !== r &&
                            ...
                            !1 === R(o) &&
                                ...
                                l.clearIncomplete &&
                                    (d(),
                                    (o = l.clearMaskOnLostFocus
                                        ? []
                                        : C().slice()))),
                            T(a, o, i, t)),
                            H !== A().join('') &&
                                ((H = o.join('')), n.trigger('change'));
                    }
                },
            ...
            switch (r.action) {
                ...
                case 'unmaskedvalue':
                    return (
                        ($ !== i && r.value === i) ||
                            ((ie = r.value),
                            (ie = (e.isFunction(l.onBeforeMask)
                                              ...
                                              if (!0 !== a.noValuePatching) {
                                                  if (
                                                      ...
                                                      n.__lookupGetter__ &&
                                                          ...
                                                          ((s = t.__lookupGetter__(
                                                              'value',
                                                          )),
                                                          (l = t.__lookupSetter__(
                                                              'value',
                                                          )),
                                                          t.__defineGetter__(
                                                              'value',
    ...
    return (
        (a.prototype = {
            ...
            analyseMask: function (t, n, r) {
                    ...
                    if (n)
                        ...
                        if (c && !b) {
                            ...
                            t.matches.splice(s++, 0, {
                                ...
                                optionality: t.isOptional,
                                newBlockMarker:
                                    l === i || (l.def !== o && null !== l.fn),
                                casing: null,
                                def: r.staticDefinitionSymbol || o,
                                placeholder:
                                    r.staticDefinitionSymbol !== i ? o : i,
                                nativeDef: o,
                            }),
                                (b = !1);
                    }
                ...
                for (
                    n &&
                    ((r.optionalmarker.start = i), (r.optionalmarker.end = i));
                    ...
                    if (b) c();
                        ...
                        switch (p.charAt(0)) {
                            ...
                            case r.groupmarker.end:
                                if (
                                    ((h = E.pop()), (h.openGroup = !1), h !== i)
                                )
                                    if (E.length > 0) {
                                        if (
                                            ((m = E[E.length - 1]).matches.push(
                                                h,
                                            ),
                                            m.isAlternator)
                                        ) {
