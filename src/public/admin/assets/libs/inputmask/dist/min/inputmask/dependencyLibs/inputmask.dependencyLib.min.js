...
!(function (e) {
    'function' == typeof define && define.amd
        ...
        : (window.dependencyLib = e(window, document));
})(function (e, t) {
    function n(e, t) {
    ...
    for (
        var s = {},
            f = 'Boolean Number String Function Array Date RegExp Object Error'.split(
                ' ',
            ),
            c = 0;
        c < f.length;
    ...
    return (
                ...
                if (a(this[0]))
                    for (
                        ...
                        for (
                            ...
                            })(s[f].ev, s[f].namespace, s[f].handler);
                return this;
            },
            trigger: function (e) {
                if (a(this[0]))
                    for (
                        ...
                        if (void 0 !== t && 'global' === c) {
                            ...
                            if (t.createEvent) {
                                ...
                                e.type && l.extend(u, e), i.dispatchEvent(u);
                            } else
                                ((u = t.createEventObject()).eventType = f),
                                    e.type && l.extend(u, e),
                            ...
                            if (
                                ...
                                for (var d in n[f])
                                    for (v = 0; v < n[f][d].length; v++)
                                        n[f][d][v].apply(i, arguments);
                            else
                                for (v = 0; v < n[f][c].length; v++)
                                    n[f][c][v].apply(i, arguments);
                    }
                return this;
            },
        }),
                    ...
                    for (t in e)
                        (n = a[t]),
                            a !== (i = e[t]) &&
                                (c &&
                                i &&
                                (l.isPlainObject(i) || (o = l.isArray(i)))
                                    ? (o
                                          ? ((o = !1),
                                            (r = n && l.isArray(n) ? n : []))
                                          : (r =
        ...
        (l.map = function (e, t) {
            var n,
                ...
                o = e.length,
                a = [];
            if (r(e)) for (; i < o; i++) null != (n = t(e[i], i)) && a.push(n);
        ...
        'function' == typeof e.CustomEvent
            ...
            : ((l.Event = function (e, n) {
              ...
              (l.Event.prototype = e.Event.prototype)),
        l
    );
});
