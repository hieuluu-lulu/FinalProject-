            ...
            numeric: {
                ...
                postValidation: function (r, a, n) {
                    var o = n.suffix.split(''),
                        p = n.prefix.split('');
                    if (a.pos === t && a.caret !== t && !0 !== a.dopost)
                        return a;
                    var l = a.caret !== t ? a.caret : a.pos,
                        s = r.slice();
                    n.numericInput &&
                        ((l = s.length - l - 1), (s = s.reverse()));
                    var g = s[l];
                    if (
                        (g === n.groupSeparator && (g = s[(l += 1)]),
                        l === s.length - n.suffix.length - 1 &&
                            g === n.radixPoint)
                    )
                        return a;
                    g !== t &&
                    ...
                    if (
                        ...
                        (c = c.replace(
                            new RegExp(
                                i.escapeRegex(n.negationSymbol.back) + '$',
                            ),
                            '',
                        )),
                        isNaN(n.placeholder) &&
                        ...
                        if (
                            ...
                            -1 === d &&
                                (c.push(n.radixPoint), (d = c.length - 1));
                            for (var x = 1; x <= n.digits; x++)
                                (n.digitsOptional &&
                                    (!n.enforceDigitsOnBlur ||
                                        'blur' !== a.event)) ||
                                (c[d + x] !== t &&
                                    c[d + x] !== n.placeholder.charAt(0))
                                    ? -1 !== u &&
                                      s[u + x] !== t &&
                                      (c[d + x] = c[d + x] || s[u + x])
                                    : (c[d + x] =
                    ...
                    var h = {
                        caret:
                            g === t || a.pos !== t
                                ? l + (n.numericInput ? -1 : 1)
                                : l,
                        buffer: c,
                        refreshFromBuffer:
                            a.dopost || r.join('') !== c.join(''),
                    };
                ...
                regex: {
                    integerPart: function (e, t) {
                        return t
                            ? new RegExp(
                                  '[' +
                                      i.escapeRegex(e.negationSymbol.front) +
                                      '+]?',
                              )
                            : new RegExp(
                                  '[' +
                    ...
                    '~': {
                        validator: function (e, r, a, n, o, p) {
                            var l = n
                                ? new RegExp(
                                      '[0-9' +
                                          i.escapeRegex(o.groupSeparator) +
                                          ']',
                                  ).test(e)
                            ...
                            if (!0 === l) {
                                if (
                                    ...
                                    for (
                                        s === o.radixPoint && (s = c);
                                        null ===
                                        s.match(i.escapeRegex(c) + '$');

                                    )
                                        c = c.slice(1);
                                    l =
                                        (s = (s = s.replace(c, '')).split(''))[
                                            a
                                        ] === t
                                            ? { pos: a, remove: a }
                                            : { pos: a };
                    ...
                    ':': {
                        validator: function (e, t, r, a, n) {
                            ...
                            return (
                                p &&
                                    t.validPositions[r] &&
                                    t.validPositions[r].match.placeholder ===
                                        n.radixPoint &&
                                    (p = { caret: r + 1 }),
                                p
                            );
                ...
                onUnMask: function (e, t, r) {
                    ...
                    return (
                        ...
                        '' !== r.placeholder.charAt(0) &&
                            (a = a.replace(
                                new RegExp(r.placeholder.charAt(0), 'g'),
                                '0',
                            )),
                        r.unmaskAsNumber
                            ? ('' !== r.radixPoint &&
                                  ...
                                  (a = a.replace(
                                      i.escapeRegex.call(this, r.radixPoint),
                                      '.',
                                  )),
                              (a = a.replace(
                                  new RegExp(
                                      '^' +
                                          i.escapeRegex(r.negationSymbol.front),
                                  ),
                                  '-',
                              )),
                              (a = a.replace(
                                  new RegExp(
                                      i.escapeRegex(r.negationSymbol.back) +
                                          '$',
                                  ),
                                  '',
                              )),
                    ...
                    if (
                        ((e =
                            p && o
                                ...
                                : e.replace(
                                      new RegExp(
                                          i.escapeRegex(r.groupSeparator),
                                          'g',
                                      ),
                                      '',
                                  )),
