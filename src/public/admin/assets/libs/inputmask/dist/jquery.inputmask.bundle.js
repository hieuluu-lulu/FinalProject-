            ...
            function generateMaskSet(opts, nocache) {
                ...
                if (
                    ...
                    if (opts.mask.length > 1) {
                        opts.keepStatic =
                            null === opts.keepStatic || opts.keepStatic;
            ...
            function maskScope(actionObj, maskset, opts) {
                function getMaskTemplate(baseOnInput, minimalPos, includeMode) {
                    ...
                    do {
                        !0 === baseOnInput && getMaskSet().validPositions[pos]
                            ? ((test = (testPos = getMaskSet().validPositions[
                                  pos
                              ]).match),
                ...
                function stripValidPositions(start, end, nocheck, strict) {
                        ...
                        getMaskSet().validPositions[i] !== undefined &&
                            ((!0 !== nocheck &&
                                ((!getMaskSet().validPositions[i].match
                                    .optionality &&
                                    (function (pos) {
                                        var posMatch = getMaskSet()
                                            .validPositions[pos];
                                        if (
                                            posMatch !== undefined &&
                                            null === posMatch.match.fn
                                        ) {
                                            var prevMatch = getMaskSet()
                                                    .validPositions[pos - 1],
                                                nextMatch = getMaskSet()
                                                    .validPositions[pos + 1];
                                            return (
                                                prevMatch !== undefined &&
                                                nextMatch !== undefined
                    ...
                    for (
                        ...
                        for (
                            ;
                            getMaskSet().validPositions[startPos] !== undefined;
                ...
                function getTests(pos, ndxIntlzr, tstPs) {
                    function resolveTestFromToken(
                        ...
                        function handleMatch(
                            ...
                            function isFirstMatch(latestMatch, tokenGroup) {
                                var firstMatch =
                                    0 ===
                                    $.inArray(latestMatch, tokenGroup.matches);
                                return (
                                    firstMatch ||
                                        $.each(
                                            tokenGroup.matches,
                            ...
                            function resolveNdxInitializer(
                                ...
                                if (
                                    ...
                                    for (
                                        var vpAlternation = getMaskSet()
                                                .validPositions[pos - 1]
                                                .locator,
                                            tpAlternation = getMaskSet().tests[
                                                pos
                                            ][0].locator,
                                            i = 0;
                                        i < targetAlternation;
                    ...
                    function filterTests(tests) {
                        if (
                            ...
                            if (
                                getMaskSet().validPositions[pos - 1]
                                    .alternation === tests[0].alternation
                            )
                                return [determineTestTemplate(tests)];
                ...
                function isValid(
                    ...
                    function fillMissingNonMask(maskPos) {
                        ...
                        for (pndx++; pndx < maskPos; pndx++)
                            getMaskSet().validPositions[pndx] === undefined &&
                                (!1 === opts.jitMasking ||
                                    opts.jitMasking > pndx) &&
                                ('' ===
                                    (testsFromPos = getTests(
                                        pndx,
                                        getTestTemplate(pndx - 1).locator,
                                        pndx - 1,
                                    ).slice())[testsFromPos.length - 1].match
                                        .def && testsFromPos.pop(),
                                (testTemplate = determineTestTemplate(
                                    testsFromPos,
                                )) &&
                    ...
                    pos.begin !== undefined &&
                        (maskPos =
                            isRTL && !isSelection(pos) ? pos.end : pos.begin);
                    var result = !0,
                        positionsClone = $.extend(
                            !0,
                            {},
                    ...
                    if (
                        ...
                        if (
                            ...
                            var currentPosValid = getMaskSet().validPositions[
                                maskPos
                            ];
                            if (
                                !currentPosValid ||
                                                    ...
                                                    for (
                                                        ...
                                                        if (
                                                            ...
                                                            var tests = getTests(
                                                                ...
                                                                bestMatch = determineTestTemplate(
                                                                    tests,
                                                                    !0,
                                                                ),
                                                                equality = -1;
                        ...
                        !1 === result &&
                            ...
                            (result = (function (pos, c, strict) {
                                ...
                                for (
                                    prevAltPos = getMaskSet().validPositions[
                                        lAltPos
                                    ];
                                    lAltPos >= 0;
                                    lAltPos--
                                    ...
                                    if (
                                        (altPos = getMaskSet().validPositions[
                                            lAltPos
                                        ]) &&
                                        ...
                                        if (
                                            ((lastAlt = lAltPos),
                                            (alternation = getMaskSet()
                                                .validPositions[lastAlt]
                                                .alternation),
                                            prevAltPos.locator[
                                                altPos.alternation
                                            ] !==
                                ...
                                if (alternation !== undefined) {
                                    ...
                                    var possibilityPos = getMaskSet()
                                            .validPositions[decisionPos],
                                        prevPos = getMaskSet().validPositions[
                                            decisionPos - 1
                                        ];
                                    $.each(
                                        getTests(
                ...
                function getPlaceholder(pos, test, returnPL) {
                    if (
                        (test = test || getTest(pos).match).placeholder !==
                            undefined ||
                        !0 === returnPL
                    )
                            ...
                            if (charCode !== undefined)
                                if (
                                    ...
                                    var lvp = getLastValidPosition(
                                        ...
                                        lvTest = getMaskSet().validPositions[
                                            lvp
                                        ],
                ...
                function caret(input, begin, end, notranslate) {
                    ...
                    if (
                        ...
                        (begin = translatePosition(begin)),
                            (end =
                                'number' ==
                                typeof (end = translatePosition(end))
                                    ? end
                                    : begin);
                        var scrollCalc =
                            parseInt(
                                ...
                                if (opts.keepStatic) {
                                    for (
                                        var validInputs = [],
                                            ...
                                            prevAltPos = getMaskSet()
                                                .validPositions[lastAlt];
                                        lastAlt >= 0;
                                        lastAlt--
                                    ) {
                                        var altPos = getMaskSet()
                                            .validPositions[lastAlt];
                                        if (altPos) {
                                            if (
                ...
                function renderColorMask(input, caretPos, clear) {
                    ...
                    if (colorMask !== undefined) {
                        ...
                        if (
                                    ...
                                    getMaskSet().validPositions[pos]
                                        ...
                                        : ((testPos = getTestTemplate(
                                          ...
                                          (!1 === opts.jitMasking ||
                                              pos < lvp ||
                                              ('number' ==
                                                  typeof opts.jitMasking &&
                                                  isFinite(opts.jitMasking) &&
                                                  opts.jitMasking > pos)) &&
                                              (handleStatic(),
                                              (maskTemplate += getPlaceholder(
                                                  pos,
                                                  test,
                                              )))),
                                    pos++;
                            ...
                            -1 === maskTemplate.indexOf('im-caret') &&
                                handleCaret(!0),
                                ...
                                if (
                                    ...
                                    (function (input, inputValue, caretPos) {
                                        if (
                                            ...
                                            return (
                                                (keypress.which = opts.radixPoint.charCodeAt(
                                                    0,
                                                )),
                                                EventHandlers.keypressEvent.call(
                                                    input,
                                        ...
                                        (function (
                                            ...
                                            if (iemobile) {
                                                ...
                                                if (1 === inputChar.length) {
                                                    ...
                                                    return (
                                                        (keypress.which = inputChar.charCodeAt(
                                                            0,
                                                        )),
                                                        EventHandlers.keypressEvent.call(
                                                            input,
                        ...
                        focusEvent: function (e) {
                            ...
                            opts.showMaskOnFocus &&
                                ...
                                !0 === opts.positionCaretOnTab &&
                                    ...
                                    EventHandlers.clickEvent.apply(input, [
                                        e,
                                        !0,
                                    ])),
                                (undoValue = getBuffer().join(''));
                ...
                Inputmask.prototype.positionColorMask = function (
                    input,
                    template,
                ) {
                    input.style.left = template.offsetLeft + 'px';
                        ...
                        case 'mask':
                            !(function (elem) {
                                ...
                                var isSupported = (function (input, opts) {
                                    var elementType = input.getAttribute(
                                            'type',
                                        ),
                                        isSupported =
                                            ('INPUT' === input.tagName &&
                                ...
                                if (maskToken.matches.hasOwnProperty(match)) {
                                    ...
                                    undefined
                                        ...
                                        : (maskToken.matches[
                                              ...
                                              return (
                                                  st ===
                                                  opts.optionalmarker.start
                                                      ? (st =
                                                            opts.optionalmarker
                                                                .end)
                                                      : st ===
                                                        opts.optionalmarker.end
                                                      ? (st =
                                                            opts.optionalmarker
                                                                .start)
                                                      : st ===
        ...
        module.exports = function (useSourceMap) {
            ...
            return (
                ...
                (list.i = function (modules, mediaQuery) {
                    ...
                    for (
                        var alreadyImportedModules = {}, i = 0;
                        i < this.length;
                        i++
                    ) {
                        var id = this[i][0];
    ...
    function (module, exports, __webpack_require__) {
        ...
        function insertStyleElement(options, style) {
            ...
            if ('top' === options.insertAt)
                ...
                if (
                    'object' != typeof options.insertAt ||
        ...
        function addStyle(obj, options) {
            ...
            if (options.singleton) {
                ...
                (style =
                    singleton || (singleton = createStyleElement(options))),
        ...
        var stylesInDom = {},
            isOldIE = (function (fn) {
                ...
                return function () {
                    return (
                        void 0 === memo && (memo = fn.apply(this, arguments)),
                        memo
                    );
                };
            })(function () {
                    ...
                    'dd/mm/yyyy': {
                        ...
                        isInYearRange: function (chrs, minyear, maxyear) {
                            ...
                            var enteredyear = parseInt(
                                    chrs.concat(
                                        minyear.toString().slice(chrs.length),
                                    ),
                                ),
                                enteredyear2 = parseInt(
                                    chrs.concat(
                                        maxyear.toString().slice(chrs.length),
                                    ),
                                );
                            return (
                                (!isNaN(enteredyear) &&
                        ...
                        determinebaseyear: function (minyear, maxyear, hint) {
                            ...
                            if (maxyear < currentyear) {
                                for (
                                    var maxYearPrefix = maxyear
                                            .toString()
                                            .slice(0, 2),
                                        maxYearPostfix = maxyear
                                            .toString()
                                            .slice(2, 4);
                            ...
                            if (
                                ...
                                for (
                                    ...
                                    currentYearPrefix--;
                                var currentYearAndHint =
                                    currentYearPrefix + hint;
                        ...
                        getFrontValue: function (mask, buffer, opts) {
                            for (
                                ...
                                var definition =
                                    opts.definitions[mask.charAt(i)];
                                definition
                                    ? ((start += length),
                            ...
                            return (
                                0 === opts.mask.indexOf('y')
                                    ? ((year = bufferStr.substr(0, 4)),
                                      (dayMonthValue = bufferStr.substring(
                                          4,
                                          10,
                                      )))
                                ...
                                prevalidator: [
                                    {
                                        validator: function (
                                            ...
                                            var isValid =
                                                1 === pchrs.length
                                                    ? opts.regex.val1pre.test(
                                                          pchrs,
                                                      )
                                                    : opts.regex.val1.test(
                                                          pchrs,
                                                      );
                                            if (
                                                (isValid &&
                            ...
                            h: {
                                validator: function (
                                    ...
                                    if (
                                        ...
                                        return (
                                            (maskset.buffer[pos - 1] = '0'),
                                            (maskset.buffer[pos] = chrs.charAt(
                                                0,
                                            )),
                                            pos++,
                                            {
                                    ...
                                    if (
                                        ...
                                        return (
                                            24 === tmp
                                                ? ((maskset.buffer[pos + 5] =
                                                      'a'),
                                                  (maskset.buffer[pos + 6] =
                                                      'm'))
                                                : ((maskset.buffer[pos + 5] =
                                                      'p'),
                                                  (maskset.buffer[pos + 6] =
                                ...
                                prevalidator: [
                                    {
                                        validator: function (
                                            ...
                                            var isValid = opts.regex.hrspre.test(
                                                chrs,
                                            );
                                            return strict ||
                                                isValid ||
                                ...
                                prevalidator: [
                                    {
                                        validator: function (
                                            ...
                                            var isValid = opts.regex.mspre.test(
                                                chrs,
                                            );
                                            return strict ||
                                                isValid ||
                                                !(isValid = opts.regex.ms.test(
                                                    '0' + chrs,
                                                ))
                                                ? isValid
                                                : ((maskset.buffer[pos] = '0'),
                ...
                Inputmask.extendAliases({
                    numeric: {
                        ...
                        postValidation: function (buffer, currentResult, opts) {
                            ...
                            opts.numericInput &&
                                ((caretPos =
                                    processValue.length - caretPos - 1),
                        ...
                        onBeforeMask: function (initialValue, opts) {
                            ...
                            if (
                                ...
                                if (
                                    parseInt(opts.digits) <
                                    decPart.toString().length
                                ) {
                                    var digitsFactor = Math.pow(
                                        10,
                                        parseInt(opts.digits),
                                    );
                                    (initialValue = initialValue.replace(
                        ...
                        canClearPosition: function (
                            ...
                            var vp = maskset.validPositions[position],
                                canClear =
                                    ...
                                    (null !==
                                        maskset.validPositions[position].match
                                            .fn &&
                ...
                (Inputmask.prototype.analyseMask = function (
                    ...
                    function reduceVariations(
                        ...
                        for (
                            ...
                            (maskGroup[
                                (variation = (mask =
                                    masks[i].mask || masks[i]).substr(0, 1))
                            ] = maskGroup[variation] || []),
                ...
                void 0 === $.fn.inputmask &&
                    ($.fn.inputmask = function (fn, options) {
                        ...
                        if (
                            ...
                            if (
                                'object' ==
                                (void 0 === fn ? 'undefined' : _typeof(fn))
                            )
                                return (
                            ...
                            if (void 0 === fn)
                                return this.each(function () {
                                    (nptmask = new Inputmask(options)).mask(
                                        this,
                                    );
                                });
                        }
