(function (b) {
    function c(D) {
            ...
            function R() {
                ...
                function V() {
                    ...
                    for (var ab = 0; ab < T.length; ++ab) {
                        if (
                            T[ab].percent >=
                            a.series.pie.label.threshold * 100
                        ) {
                            aa(T[ab], ac, ab);
                        }
                        ac += T[ab].angle;
                    ...
                    function aa(ap, ai, ag) {
                        ...
                        var am =
                            p +
                            Math.round(Math.sin(aj) * Z) * a.series.pie.tilt;
                        var af =
        ...
        function s(Q, R) {
            for (
                var S = false, P = -1, N = Q.length, O = N - 1;
                ++P < N;
                O = P
            ) {
                ((Q[P][1] <= R[1] && R[1] < Q[O][1]) ||
        ...
        function H(Q, R) {
            var P = Q.getOptions();
            var N =
                P.series.pie.radius > 1
                    ? P.series.pie.radius
                    : n * P.series.pie.radius;
            R.save();
            R.translate(B, p);
