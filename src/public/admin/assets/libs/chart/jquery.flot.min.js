    ...
    function b(av, ai, J, af) {
        ...
        function z() {
            ...
            for (aU = 0; aU < Q.length; ++aU) {
                ...
                if (aJ.bars.show) {
                    var aY =
                        aJ.bars.align == 'left' ? 0 : -aJ.bars.barWidth / 2;
                    if (aJ.bars.horizontal) {
                        aQ += aY;
            ...
            if (O.grid.show) {
                ...
                if (aD == null) {
                    ...
                    for (aC = 0; aC < Q.length; ++aC) {
                        aD = Math.max(
                            aD,
                            Q[aC].points.radius + Q[aC].points.lineWidth / 2,
                        );
                    }
                }
                for (var aB in q) {
        ...
        function S(aG) {
            ...
            if (aM.mode == 'time') {
                ...
                if (aN == 'year') {
                    aQ = Math.pow(
                        10,
                        Math.floor(Math.log(aT / aJ.year) / Math.LN10),
                    );
                    aI = aT / aJ.year / aQ;
                    if (aI < 1.5) {
                        aO = 1;
            ...
            if (aM.alignTicksWithAxis != null) {
                var aF = (aG.direction == 'x' ? p : aw)[
                    aM.alignTicksWithAxis - 1
                ];
                if (aF && aF.used && aF != aG) {
                    var aL = aB(aG);
                    if (aL.length > 0) {
                    ...
                    if (aG.mode != 'time' && aM.tickDecimals == null) {
                        var aE = Math.max(
                                0,
                                -Math.floor(Math.log(aT) / Math.LN10) + 1,
                            ),
                            aD = aB(aG);
                        if (
                            !(
                                aD.length > 1 &&
                                /\..*0$/.test((aD[1] - aD[0]).toFixed(aE))
                            )
                        ) {
                            aG.tickDecimals = aE;
                        }
            ...
            for (var aD = 0; aD < aJ.length; ++aD) {
                ...
                for (var aE = 0; aE < aC.ticks.length; ++aE) {
                    ...
                    if (aC.direction == 'x') {
                        aI = 'center';
                        aK.left = Math.round(
                            q.left + aC.p2c(aH.v) - aC.labelWidth / 2,
                        );
                        ...
                        aK.top = Math.round(
                            q.top + aC.p2c(aH.v) - aC.labelHeight / 2,
                        );
                        if (aC.position == 'left') {
        ...
        function K(aI, aG, aD) {
            ...
            for (aW = Q.length - 1; aW >= 0; --aW) {
                ...
                if (aP.bars.show && !aY) {
                    var aE =
                            aP.bars.align == 'left' ? 0 : -aP.bars.barWidth / 2,
            ...
            if (aY) {
                ...
                return {
                    datapoint: Q[aW].datapoints.points.slice(
                        aU * aT,
                        (aU + 1) * aT,
                    ),
                    dataIndex: aU,
