...
(function (global, factory) {
    ...
    function reverseDirection(direction) {
        ...
        return mapping.hasOwnProperty(direction)
            ? mapping[direction]
            : direction;
    }
    ...
    var GradientString = {
        ...
        parseString: function parseString(string) {
            ...
            if ((matched = RegExpStrings.FULL.exec(string)) !== null) {
                ...
                return {
                    prefix:
                        typeof matched[1] === 'undefined' ? null : matched[1],
                    type: matched[2],
                    value: value,
                };
            } else {
        ...
        formatStops: function formatStops(stops, cleanPosition) {
            ...
            for (var i = 0; i < stops.length; i++) {
                stop = stops[i];
                if (
                    typeof stop.position === 'undefined' ||
                    stop.position === null
                ) {
                    if (i === 0) {
                        position = 0;
            ...
            positions = (function (data) {
                ...
                for (var _i = 0; _i < data.length; _i++) {
                    if (isNaN(data[_i])) {
                        ...
                        average =
                            (data[_i] - data[start - 1]) / (_i - start + 1);
                        for (var j = start; j < _i; j++) {
                            data[j] =
                                data[start - 1] + (j - start + 1) * average;
                        }
                        start = null;
                    }
                }
        ...
        LINEAR: {
            ...
            to: function to(gradient, instance, prefix) {
                ...
                if (gradient.stops.length === 1) {
                    return gradient.stops[0].color.to(
                        instance.options.degradationFormat,
                    );
                }
                ...
                if (
                    prefix &&
                    -1 !==
                        _jquery2.default.inArray(
                            prefix,
                            instance.options.prefixes,
                        )
                ) {
                    standard = false;
                    _prefix = prefix;
            ...
            [
                ...
                },
                {
                    ...
                    value: function reorder() {
                        ...
                        this.value.stops = this.value.stops.sort(function (
                            a,
                            b,
                        ) {
                ...
                },
                {
                    ...
                    value: function toString(prefix) {
                        ...
                        return GradientTypes[this.type()].to(
                            this.value,
                            this,
                            prefix,
                        );
                ...
                },
                {
                    ...
                    value: function toStringWithAngle(angle, prefix) {
                        var value = _jquery2.default.extend(
                            true,
                            {},
                            this.value,
                        );
                    ...
                    value: function getPrefixedStrings() {
                        ...
                        for (var i in this.options.prefixes) {
                            if (
                                ...
                                strings.push(
                                    this.toString(this.options.prefixes[i]),
                                );
                            }
                        }
                        return strings;
