                            ...
                            return (
                                ...
                                r.isArray(t.className)
                                    ...
                                    : 'string' == typeof t.className &&
                                      (this.className = t.className.split(
                                          /\s+/,
                                      )),
                                !0
                            );
                    ...
                    return (
                        ...
                        (t.prototype.sliceNormalRenderRanges = function (t) {
                            ...
                            for (e = 0; e < r.length; e++)
                                (n = r[e]),
                                    (i = n.dateProfile.unzonedRange.intersect(
                                        t,
                ...
                p = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ...
                            i.initRenderQueue(),
                            i.initHiddenDays(),
                            (i.dateProfileGenerator = new i.dateProfileGeneratorClass(
                                i,
                            )),
                                ...
                                (this.nowIndicatorTimeoutID = setTimeout(
                                    function () {
                                        (i.nowIndicatorTimeoutID = null),
                                            ...
                                            (n = +o.duration(1, t)),
                                            (n = Math.max(100, n)),
                                            (i.nowIndicatorIntervalID = setInterval(
                                                e,
                                                n,
                                            ));
                                    },
                ...
                o = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.renderFgRanges = function (t) {
                            var e = this.component.eventRangesToEventFootprints(
                                    t,
                                ),
                    ...
                    return (
                        ...
                        (e.prototype.renderHeadDateCellHtml = function (
                            ...
                            var i,
                                o = this,
                                s = o.view,
                                a = o.dateProfile.activeUnzonedRange.containsDate(
                                    t,
                                ),
                                l = [
                                    'fc-day-header',
                        ...
                        (e.prototype.renderBgCellHtml = function (t, e) {
                            var n = this,
                                i = n.view,
                                r = n.dateProfile.activeUnzonedRange.containsDate(
                                    t,
                                ),
                                o = n.getDayClasses(t);
                            return (
                    ...
                    return (
                        ...
                        (e.prototype.renderNumberCellHtml = function (t) {
                            var e,
                                ...
                                i = this.view,
                                r = '',
                                o = this.dateProfile.activeUnzonedRange.containsDate(
                                    t,
                                ),
                        ...
                        (e.prototype.queryHit = function (t, e) {
                            if (
                                ...
                                var n = this.colCoordCache.getHorizontalIndex(
                                        t,
                                    ),
                        ...
                        (e.prototype.computeRowLevelLimit = function (t) {
                            ...
                            var n,
                                ...
                                s = this.rowEls.eq(t),
                                a = s.height(),
                                l = this.eventRenderer.rowStructs[
                                    t
                                ].tbodyEl.children();
                        ...
                        (e.prototype.getCellSegs = function (t, e, n) {
                            for (
                                var i,
                                    r = this.eventRenderer.rowStructs[t]
                                        .segMatrix,
                                    o = n || 0,
                                    s = [];
                                o < r.length;
                    ...
                    return (
                        ...
                        (e.prototype.updateSize = function (e, n, i) {
                            var r,
                                ...
                                l = this.dayGrid.headContainerEl.find(
                                    '.fc-row',
                                );
                    ...
                    return (
                        ...
                        (t.prototype.constraintValToFootprints = function (
                            ...
                            return 'businessHours' === t
                                ...
                                : null != t
                                ? ((n = this.eventManager.getEventInstancesWithId(
                                      t,
                                  )),
                                  this.eventInstancesToFootprints(n))
                                : void 0;
            ...
            var r = n(2),
                ...
                p = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.triggerBeforeEventSegsDestroyed = function (
                            t,
                        ) {
                            var e = this;
                                ...
                                hitOver: function (n, l, c) {
                                    ...
                                    g && v
                                        ? ((i = e
                                          ...
                                          i
                                              ? ((h = d.buildMutatedEventInstanceGroup(
                                                    p.id,
                                                    i,
                                                )),
                                                (f = s.isEventInstanceGroupAllowed(
                                                    h,
                                                )))
                                              : (f = !1))
                                        : (f = !1),
                            ...
                            var g = (this.dragListener = new l.default(a, {
                                ...
                                hitOver: function (e, l, u) {
                                    var p,
                                        ...
                                        y = !0;
                                    t.hit && (u = t.hit),
                                        (p = u.component.getSafeHitFootprint(
                                            u,
                                        )),
                                        (f = e.component.getSafeHitFootprint(
                                            e,
                                        )),
                                        p && f
                                            ? ((i = o.computeEventDropMutation(
                                              ...
                                              i
                                                  ? ((v = c.buildMutatedEventInstanceGroup(
                                                        h.id,
                                                        i,
                                                    )),
                                                    (y = s.isEventInstanceGroupAllowed(
                                                        v,
                                                    )))
                                                  : (y = !1))
                                            : (y = !1),
                    ...
                    return (
                        ...
                        (e.prototype.renderSlats = function () {
                            ...
                            (this.slatContainerEl = this.el
                                ...
                                (this.slatEls = this.slatContainerEl.find(
                                    'tr',
                                )),
