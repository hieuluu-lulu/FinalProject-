...
!(function (t, e) {
    if ('function' == typeof define && define.amd)
        ...
        var i = { exports: {} };
        e(t.jQuery, t.AsColor, t.AsGradient),
            (t.jqueryAsColorPickerEs = i.exports);
    }
})(this, function (t, e, i) {
    'use strict';
    function a(t) {
    ...
    var r = a(t),
        ...
        v = {
            ...
            init: function (t, e) {
                ...
                (this.options = $.extend(this.defaults, e)),
                    ...
                    (this.api = t),
                    (this.$hue = $(this.options.template.call(i)).appendTo(
                        t.$dropdown,
                    )),
        ...
        m = {
            defaults: {
                template: function (t) {
                    return (
                        '<div class="' + t + '-saturation"><i><b></b></i></div>'
                    );
                },
            },
            width: 0,
            ...
            init: function (t, e) {
                ...
                (this.options = $.extend(
                    ...
                    t.$element.on('asColorPicker::firstOpen', function () {
                        i.options.apply &&
                            (i.$apply = $(
                                i.options.applyTemplate.call(i, t.namespace),
                            )
                                .appendTo(i.$buttons)
                                .on('click', function () {
                                    return t.apply(), !1;
    ...
    var b = {
                    ...
                    t.$element.on('asColorPicker::apply', function (t, e, a) {
                        ...
                        -1 === $.inArray(n, i.colors) &&
                            (i.colors.length >= i.options.max &&
                                (i.colors.shift(),
                                i.$palettes.find('li').eq(0).remove()),
                            i.colors.push(n),
        ...
        C = function (t, e) {
            ...
            $.extend(i, {
                init: function () {
                    (i.$wrap = $(i.options.template.call(i)).appendTo(
                        t.$dropdown,
                    )),
                        (i.$gradient = i.$wrap.filter(
                            '.' + t.namespace + '-gradient',
                        )),
                        this.angle.init(),
                        this.preview.init(),
                        this.markers.init(),
                ...
                bind: function () {
                    ...
                    i.$gradient.on('update', function () {
                        ...
                        e && t._trigger('update', e.color, i.value),
                            t.element.value !== i.value.toString() &&
                                t._updateInput();
                    }),
                        i.options.switchable &&
                            i.$wrap.on(
                                ...
                                function () {
                                    return (
                                        i.isEnabled ? i.disable() : i.enable(),
                                        !1
                                    );
                                },
                            ),
                ...
                overrideCore: function () {
                    (t.set = function (e) {
                        if (((t.isEmpty = '' === e), 'string' == typeof e))
                            ...
                            a &&
                                (a.color.val(e),
                                t._trigger('update', a.color, i.value)),
                ...
                preview: {
                    ...
                    render: function () {
                        i.$preview.css({
                            'background-image': i.value.toStringWithAngle(
                                'to right',
                                !0,
                            ),
                        }),
                ...
                wheel: {
                    ...
                    calAngle: function (t, e) {
                        var i = Math.round(
                            Math.atan(Math.abs(t / e)) * (180 / Math.PI),
                        );
                        return t < 0 && e > 0
                            ? 360 - i
                            : t < 0 && e <= 0
                    ...
                    set: function (t) {
                        i.value.angle(t),
                            i.$gradient.trigger('update', { angle: t });
                    },
                    position: function (t) {
                            ...
                            value: function () {
                                (this.color = (0, h.default)(
                                    ...
                                    this.options.skin &&
                                        ...
                                        this.$element
                                            .parent()
                                            .addClass(this.classes.skin)),
                                    this.options.readonly &&
                                        this.$element.prop('readonly', !0),
                                    this._bindEvent(),
                                    (this.initialed = !0),
                                    this._trigger('ready');
                            },
                                ...
                                this.disabled ||
                                    ...
                                    this.$dropdown[0] !==
                                        ...
                                        this.$dropdown
                                            .detach()
                                            .appendTo(this.$body),
                                    (this.$mask = (0, r.default)(
                                        '.' + this.classes.mask,
                                    )),
                                    0 === this.$mask.length &&
                                        this.createMask(),
                                    this.$dropdown.prev()[0] !==
                                        this.$mask[0] &&
                                    ...
                                    this.$mask.on(
                                        ...
                                        function (t) {
                                            var e = (0, r.default)(
                                                ...
                                                i = void 0;
                                            e.length > 0 &&
                                                ((i = e.data('asColorPicker'))
                                                    .opened &&
                                                    (i.options.hideFireChange
                                                        ? i.apply()
                                                        : i.cancel()),
                                                t.preventDefault(),
                                                t.stopPropagation());
