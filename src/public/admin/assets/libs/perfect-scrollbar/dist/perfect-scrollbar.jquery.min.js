                ...
                DOM.matches = function (element, query) {
                    if (typeof element.matches !== 'undefined') {
                        ...
                        if (typeof element.matchesSelector !== 'undefined') {
                            ...
                            typeof element.webkitMatchesSelector !== 'undefined'
                        ) {
                            return element.webkitMatchesSelector(query);
                        } else if (
                            typeof element.mozMatchesSelector !== 'undefined'
                        ) {
                            return element.mozMatchesSelector(query);
                        } else if (
                            typeof element.msMatchesSelector !== 'undefined'
                        ) {
        ...
        10: [
            function (require, module, exports) {
                ...
                function bindClickRailHandler(element, i) {
                    ...
                    var stopPropagation =
                        window.Event.prototype.stopPropagation.bind;

                    if (i.settings.stopPropagationOnClick) {
                        i.event.bind(i.scrollbarY, 'click', stopPropagation);
                    }
                    i.event.bind(i.scrollbarYRail, 'click', function (e) {
                        var halfOfScrollbarLength = h.toInt(
                            i.scrollbarYHeight / 2,
                        );
                        var positionTop =
                            i.railYRatio *
                            (e.pageY -
            ...
            function (require, module, exports) {
                ...
                function bindMouseScrollXHandler(element, i) {
                    ...
                    i.event.bind(i.scrollbarX, 'mousedown', function (e) {
                        ...
                        currentLeft =
                            h.toInt(d.css(i.scrollbarX, 'left')) * i.railXRatio;
                ...
                function bindMouseScrollYHandler(element, i) {
                    ...
                    i.event.bind(i.scrollbarY, 'mousedown', function (e) {
                        ...
                        currentTop =
                            h.toInt(d.css(i.scrollbarY, 'top')) * i.railYRatio;
            ...
            function (require, module, exports) {
                ...
                function bindMouseWheelHandler(element, i) {
                    ...
                    function shouldBeConsumedByTextarea(deltaX, deltaY) {
                        var hoveredTextarea = element.querySelector(
                            'textarea:hover',
                        );
                        if (hoveredTextarea) {
                            var maxScrollTop =
                                hoveredTextarea.scrollHeight -
                                hoveredTextarea.clientHeight;
                            if (maxScrollTop > 0) {
                                if (
                                    !(
                                        hoveredTextarea.scrollTop === 0 &&
                                        deltaY > 0
                                    ) &&
                                    !(
                                        hoveredTextarea.scrollTop ===
                                            maxScrollTop && deltaY < 0
                                    )
                                ) {
                                    return true;
                                }
                            ...
                            var maxScrollLeft =
                                hoveredTextarea.scrollLeft -
                                hoveredTextarea.clientWidth;
                            if (maxScrollLeft > 0) {
                                if (
                                    !(
                                        hoveredTextarea.scrollLeft === 0 &&
                                        deltaX < 0
                                    ) &&
                                    !(
                                        hoveredTextarea.scrollLeft ===
                                            maxScrollLeft && deltaX > 0
                                    )
                                ) {
                                    return true;
                                }
                ...
                function bindTouchHandler(
                    ...
                    function touchMove(e) {
                        if (!inGlobalTouch && inLocalTouch && shouldHandle(e)) {
                            ...
                            if (
                                shouldPreventDefault(differenceX, differenceY)
                            ) {
                                e.stopPropagation();
                                e.preventDefault();
                            }
        ...
        18: [
            function (require, module, exports) {
                ...
                function Instance(element) {
                    ...
                    i.scrollbarXBottom = h.toInt(
                        d.css(i.scrollbarXRail, 'bottom'),
                    );
                    i.isScrollbarXUsingBottom =
                        i.scrollbarXBottom === i.scrollbarXBottom; // !isNaN
                    ...
                    i.scrollbarYRight = h.toInt(
                        d.css(i.scrollbarYRail, 'right'),
                    );
                    i.isScrollbarYUsingRight =
                        i.scrollbarYRight === i.scrollbarYRight; // !isNaN
                    i.scrollbarYLeft = i.isScrollbarYUsingRight
                        ? null
                        : h.toInt(d.css(i.scrollbarYRail, 'left'));
                    i.scrollbarYOuterWidth = i.isRtl
                        ? h.outerWidth(i.scrollbarY)
                        : null;
                    i.railBorderYWidth =
                ...
                module.exports = function (element, axis, value) {
                    ...
                    if (
                        ...
                        element.scrollTop = value =
                            i.contentHeight - i.containerHeight; // don't allow scroll past container
                    ...
                    if (
                        ...
                        element.scrollLeft = value =
                            i.contentWidth - i.containerWidth; // don't allow scroll past container
