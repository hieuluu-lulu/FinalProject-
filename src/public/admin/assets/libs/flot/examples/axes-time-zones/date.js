...
(function () {
    ...
    timezoneJS.timezone = new (function () {
        ...
        function builtInLoadZoneFile(fileName, opts) {
            ...
            return !opts || !opts.async
                ...
                : _this.transport({
                      ...
                      error: function () {
                          throw new Error(
                              'Error retrieving "' + url + '" zoneinfo files',
                          );
                      },
                  });
        }
        ...
        function getZone(dt, tz) {
            var utcMillis =
                typeof dt === 'number' ? dt : new Date(dt).getTime();
            var t = tz;
        ...
        function getRule(dt, zone, isUTC) {
            ...
            var convertRuleToExactDateAndTime = function (
                yearAndRule,
                prevRule,
            ) {
