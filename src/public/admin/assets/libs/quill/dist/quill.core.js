                            ...
                            value: function setContents(delta) {
                                ...
                                return modify.call(
                                    ...
                                    function () {
                                        ...
                                        var applied = _this10.editor.applyDelta(
                                            delta,
                                        );
                                        var lastOp =
                        ...
                        [
                            {
                                ...
                                value: function compare(self, other) {
                                    ...
                                    var otherIndex = Inline.order.indexOf(
                                        other,
                                    );
                        ...
                        },
                        {
                            ...
                            value: function rangeToNative(range) {
                                ...
                                indexes.forEach(function (index, i) {
                                    ...
                                    var node = void 0,
                                        _scroll$leaf5 = _this5.scroll.leaf(
                                            index,
                                        ),
                            ...
                            value: function deleteAt(index, length) {
                                ...
                                if (
                                    ...
                                    if (first instanceof _code2.default) {
                                        ...
                                        var _newlineIndex = last.newlineIndex(
                                            0,
                                        );
                                        if (_newlineIndex > -1) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function makeCodeBlockHandler(indent) {
                    return {
                        ...
                        handler: function handler(range) {
                            var CodeBlock = _parchment2.default.query(
                                'code-block',
                            );
                            var index = range.index,
                                length = range.length;
                        ...
                        },
                        {
                            ...
                            value: function record(changeDelta, oldDelta) {
                                ...
                                if (
                                    ...
                                    changeDelta = delta.redo.compose(
                                        changeDelta,
                                    );
                                } else {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Clipboard = (function (_Module) {
                    ...
                    function Clipboard(quill, options) {
                        ...
                        _this.container = _this.quill.addContainer(
                            'ql-clipboard',
                        );
                ...
                function matchAttributor(node, delta) {
                    ...
                    var classes = _parchment2.default.Attributor.Class.keys(
                        node,
                    );
                    var styles = _parchment2.default.Attributor.Style.keys(
                        node,
                    );
                    var formats = {};
                    attributes
