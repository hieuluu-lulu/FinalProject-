...
!(function (i) {
            ...
            switch (m.control) {
                case 'wheel':
                    (e = b.width() / 2 - I.x),
                        ...
                        (n = f(
                            100 - Math.floor(S.y * (100 / w.height())),
                            0,
                            100,
                        )),
                        (p = k({ h: s, s: a, b: n })),
                ...
                case 'saturation':
                    (s = f(parseInt(I.x * (360 / b.width()), 10), 0, 360)),
                        ...
                        (n = f(
                            100 - Math.floor(I.y * (100 / b.height())),
                            0,
                            100,
                        )),
                        (p = k({ h: s, s: a, b: n })),
                ...
                default:
                    (s = f(
                        360 - parseInt(S.y * (360 / w.height()), 10),
                        0,
                        360,
                    )),
                ...
                ? ((s = v(t) ? g(t, !0) : I(u(t, !0))),
                  (o =
                      '' === i.attr('data-opacity')
                          ? 1
                          : f(
                                parseFloat(i.attr('data-opacity')).toFixed(2),
                                0,
                                1,
                            )),
            ...
            I.opacity &&
                ((n =
                    '' === t.attr('data-opacity')
                        ? 1
                        : f(
                              parseFloat(t.attr('data-opacity')).toFixed(2),
                              0,
                              1,
                          )),
                isNaN(n) && (n = 1),
    ...
    function h(t) {
        ...
        return o
            ? (void 0 !== s && i.extend(o, { a: parseFloat(s) }), o)
            : null;
    }
    function d(t, o) {
        var s,
    ...
    (i.minicolors = {
                        ...
                        return void 0 === e
                            ...
                            : (i(this).each(function () {
                                  var t =
                                      i(this).data('minicolors-settings') || {};
                                  o(i(this)),
                                      i(this).minicolors(i.extend(!0, t, e));
                              }),
                              i(this));
                    case 'show':
        ...
        i([document, top.document])
            .on('mousedown.minicolors touchstart.minicolors', function (t) {
                i(t.target).parents().add(t.target).hasClass('minicolors') ||
                    a();
            })
            .on(
