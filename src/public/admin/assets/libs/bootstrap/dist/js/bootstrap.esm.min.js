    ...
    if ('string' == typeof t && e) {
        ...
        if (c) c.oneOff = c.oneOff && o;
            ...
            var u = getUidEvent(s, t.replace(namespaceRegex, '')),
                d = a
                    ? bootstrapDelegationHandler(e, n, i)
                    : bootstrapHandler(e, n);
...
var EventHandler = {
    ...
    BaseComponent = (function () {
        function e(e) {
            e &&
                ((this._element = e),
                Data.setData(e, this.constructor.DATA_KEY, this));
        }
        return (
...
var Manipulator = {
        ...
        getDataAttribute: function (e, t) {
            return normalizeData(
                e.getAttribute('data-bs-' + normalizeDataKey(t)),
            );
        },
        offset: function (e) {
        ...
        return (
            ...
            (n._getItemByDirection = function (e, t) {
                ...
                if (((i && 0 === o) || (n && o === r)) && !this._config.wrap)
                    return t;
                var a =
                    (o + (e === DIRECTION_PREV ? -1 : 1)) % this._items.length;
                return -1 === a
...
var NAME$3 = 'collapse',
    ...
    Collapse = (function (e) {
        function t(t, n) {
            ...
            for (
                var o = SelectorEngine.find(SELECTOR_DATA_TOGGLE$1),
                    r = 0,
                    a = o.length;
                r < a;
                r++
                ...
                null !== l &&
                    E.length &&
                    ((i._selector = l), i._triggerArray.push(s));
            }
            return (
        ...
        return (
            ...
            (n._getConfig = function (e) {
                return (
                    ((e = _extends({}, Default$1, e)).toggle = Boolean(
                        e.toggle,
                    )),
        ...
        return (
            ...
            (t.clearMenus = function (e) {
                if (
                    ...
                    for (
                        var n = SelectorEngine.find(SELECTOR_DATA_TOGGLE$2),
                            i = 0,
                            o = n.length;
                        i < o;
                        i++
                        ...
                        var r = t.getParentFromElement(n[i]),
                            ...
                            s = { relatedTarget: n[i] };
                        if (
                            (e && 'click' === e.type && (s.clickEvent = e), a)
                        ) {
                            var l = a._menu;
            ...
            (t.dataApiKeydownHandler = function (e) {
                if (
                    ...
                    e.stopPropagation(),
                    !this.disabled &&
                        !this.classList.contains(CLASS_NAME_DISABLED))
                ) {
        ...
        return (
            ...
            (n._showBackdrop = function (e) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    if (this._element.classList.contains(CLASS_NAME_FADE)) {
                        var r = getTransitionDurationFromElement(
                            this._backdrop,
                        );
            ...
            (n._resetScrollbar = function () {
                SelectorEngine.find(SELECTOR_FIXED_CONTENT).forEach(function (
                    ...
                    SelectorEngine.find('' + SELECTOR_STICKY_CONTENT).forEach(
                        function (e) {
                            var t = Manipulator.getDataAttribute(
                                e,
                                'margin-right',
                            );
                            void 0 !== t &&
                ...
                var e = Manipulator.getDataAttribute(
                    document.body,
                    'padding-right',
                );
                void 0 === e
        ...
        return (
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    o.setAttribute('id', r),
                        ...
                        this.config.animation &&
                            o.classList.add(CLASS_NAME_FADE$1);
                    var a =
                    ...
                    var t = this.getTipElement(),
                        n = function () {
                            e._hoverState !== HOVER_STATE_SHOW &&
                                ...
                                e._popper &&
                                    (e._popper.destroy(), (e._popper = null));
                        };
                    if (
                        !EventHandler.trigger(
                            this._element,
            ...
            (n._enter = function (e, t) {
                ...
                (t = t || Data.getData(e.delegateTarget, n)) ||
                    ...
                    e &&
                        (t._activeTrigger[
                            'focusin' === e.type ? TRIGGER_FOCUS : TRIGGER_HOVER
                        ] = !0),
        ...
        return (
            ...
            (n.setContent = function () {
                ...
                'function' == typeof t && (t = t.call(this._element)),
                    this.setElementContent(
                        SelectorEngine.findOne(SELECTOR_CONTENT, e),
                        t,
                    ),
            ...
            (t.jQueryInterface = function (e) {
                return this.each(function () {
                    ...
                    if (
                        ...
                        (n ||
                            ((n = new t(this, i)),
                            Data.setData(this, DATA_KEY$7, n)),
                        'string' == typeof e)
                    ) {
                        if (void 0 === n[e])
                            throw new TypeError('No method named "' + e + '"');
        ...
        return (
                    ...
                    SelectorEngine.find(this._selector)
                        .map(function (e) {
                            ...
                            if (o) {
                                ...
                                if (r.width || r.height)
                                    return [Manipulator[n](o).top + i, t];
                            }
                            return null;
                        })
                        .filter(function (e) {
            ...
            (n._getConfig = function (e) {
                if (
                    ...
                    var t = e.target.id;
                    t || ((t = getUID(NAME$8)), (e.target.id = t)),
                        (e.target = '#' + t);
                }
