    ...
    (c.prototype.init = function (b) {
        ...
        function d(c, d, f) {
            ...
            if (f) b.showTooltip(f, d);
                ...
                a.each(b.getData(), function (a, c) {
                    ...
                    if (m < j.distance) {
                        var n =
                                g(k.x, k.y, d.x, d.y) < g(d.x, d.y, l.x, l.y)
                                    ? e
                                    : f,
                            o =
        ...
        b.hooks.bindEvents.push(function (b, f) {
            ...
            (b.setTooltipPosition = function (b) {
                ...
                b.x - a(window).scrollLeft() > a(window)[e.wfunc]() - d &&
                    (b.x -= d),
                    b.y - a(window).scrollTop() > a(window)[e.hfunc]() - f &&
                        (b.y -= f),
                    (e.tipPosition.x = b.x),
                    (e.tipPosition.y = b.y);
            }),
            ...
            if (
                ...
                for (var s in b.series.xaxis[q])
                    if (
                        ...
                        t === c &&
                            (a = a.replace(l, b.series.xaxis[q][r].label));
                    }
            }
            if ('undefined' != typeof b.series.yaxis.ticks)
                for (var s in b.series.yaxis.ticks)
                    if (b.series.yaxis.ticks.hasOwnProperty(s)) {
                        ...
                        u === d &&
                            (a = a.replace(m, b.series.yaxis.ticks[s].label));
                    }
            return (
