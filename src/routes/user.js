...
route.get('/reset/:token', userController.resetPasswordToken);
route.post('/reset/:token', userController.resetPasswordHandler);
route.get('/forgot', userController.forgotPassword);
route.post('/forgot', userController.forgotPasswordHandler);
